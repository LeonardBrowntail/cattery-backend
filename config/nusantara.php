    ...
    */
    'columns' => [
        'provinces' => [
            ...
            'capital' => ['name' => 'capital', 'enabled' => false],
            'latitude' => ['name' => 'latitude', 'enabled' => false],
            'longitude' => ['name' => 'longitude', 'enabled' => false],
            'elevation' => ['name' => 'elevation', 'enabled' => false],
            'timezone' => ['name' => 'timezone', 'enabled' => false],
            'area' => ['name' => 'area', 'enabled' => false],
            'population' => ['name' => 'population', 'enabled' => false],
